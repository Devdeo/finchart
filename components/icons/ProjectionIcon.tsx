...
export default function ProjectionIcon({ width = 28, height = 28 }: SVGIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width={width} height={height} fill="none">
