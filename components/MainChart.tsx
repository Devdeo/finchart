  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.mainArea}>
        ...
        {/* Second Submenu - appears next to left column */}
        {showSecondSubmenu && (
          <div className="second-submenu" style={{
            ...
            <div style={styles.submenuItem}>
              ...
              <span style={styles.submenuText}>Cross Lines</span>
            </div>
            ...
            <div style={styles.submenuItem}>
              ...
              <span style={styles.submenuText}>Horizontal Lines</span>
            </div>
            ...
            <div style={styles.submenuItem}>
              ...
              <span style={styles.submenuText}>Parallel Lines</span>
            </div>
            ...
            <div style={styles.submenuItem}>
              ...
              <span style={styles.submenuText}>Text</span>
            </div>
            ...
            <div style={styles.submenuItem}>
              ...
              <span style={styles.submenuText}>Polygon</span>
            </div>
            ...
            <div style={styles.submenuItem}>
              ...
              <span style={styles.submenuText}>Zoom</span>
            </div>
          </div>
        )}
